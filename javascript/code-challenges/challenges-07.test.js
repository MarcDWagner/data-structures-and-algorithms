...
// input is an obj and needs to get into array recipe.ingredients
// forEach to look at each ingredient and grab the name
const listFoods = (recipe) => {
  let result = [];
  // Solution code here...
  recipe.ingredients.forEach(ingredient => {
    let withoutAmount = ingredient.slice(ingredient.indexOf(' ') + 1);
    // the +1 means it goes to the space +1 more index so it doesn't bring the space with it
